...
class EasynewsSavedSearchHandler():
    ...
    def add_search_result(self, addonhandle, searchPhrase):
        xbmc.log('%s.add_search_result %s %s' % (self.name, addonhandle, searchPhrase), 1)
    ...
    def show_saved_searches(self, addonhandle, activity):
        ...
        for term in searches:
            if term != '':
                self.add_search_result(addonhandle, term)
